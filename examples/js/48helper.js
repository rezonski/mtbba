...
//     directionText += parseSurfaceTransition(wp.current.odometer, wp.next.odometer, surfaceCollection);
...
// function getSegmentName(odometar, surfaceCollection) {
...
//       surfaceCollection.forEach(function(cutpoint){
